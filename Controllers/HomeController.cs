    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Level1()
        {
            ...
            ViewBag.CityTeams = _context.Teams
                ...
                .ToList();
            ViewBag.TeamsStartsWithT = _context.Teams
                .Where(t => t.TeamName.StartsWith("T"))
                .ToList();
            ViewBag.AlphabeticalTeamsByLocation = _context.Teams
                .OrderBy(t => t.Location)
                .ToList();
            ViewBag.TeamsOrderedByReverseName = _context.Teams
                .OrderByDescending(t => t.TeamName)
                .ToList();
            ViewBag.PlayersLastNameCooper = _context.Players
                .Where(p => p.LastName.Contains("Cooper"))
                .ToList();
            ViewBag.PlayersFirstNameJoshua = _context.Players
                .Where(p => p.FirstName.Contains("Joshua"))
                .ToList();
            ViewBag.PlayersLastCooperNOTFirstJoshua = _context.Players
                .Where(p => p.LastName.Contains("Cooper"))
                .Where(p => !p.FirstName.Contains("Joshua"))
                .ToList();
            ViewBag.PlayersFirstNameAlexanderORWyatt = _context.Players
